...
class Config:
    ...
    def _parse_args(self):
        ...
        parser.add_argument(
            ...
            help="Launch task on startup", choices=["api", "core"]
        )
...
class Params(object):
    ...
    """MongoDB конфиг"""
    @property
    def _mongodb_settings(self):
        return self.__config_data.setdefault("mongodb", {})

    def get_mongodb_db(self):
        return self._mongodb_settings["db"]

    def get_mongodb_hostname(self):
        return self._mongodb_settings["hostname"]

    def get_mongodb_port(self):
        return self._mongodb_settings["port"]
